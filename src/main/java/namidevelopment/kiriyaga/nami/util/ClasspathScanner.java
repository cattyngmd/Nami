...
public class ClasspathScanner {
    ...
    public static <T> Set<Class<? extends T>> findAnnotated(Class<T> baseClass, Class<?> annotation) {
        ...
        try {
            ...
            String resourcePath = "namidevelopment/kiriyaga/nami";
            ...
            while (resources.hasMoreElements()) {
                ...
                if ("file".equals(protocol)) {
                    ...
                    if (dir.exists() && dir.isDirectory()) {
                        result.addAll(scanDirectory(dir, "namidevelopment.kiriyaga.nami", baseClass, annotation));
                    }
    ...
    private static <T> Set<Class<? extends T>> scanDirectory(File dir, String pkg, Class<T> base, Class<?> annotation) throws ClassNotFoundException {
        ...
        for (File file : Objects.requireNonNull(dir.listFiles())) {
            if (file.isDirectory()) {
                ...
                if (className.startsWith("namidevelopment.kiriyaga.nami.mixin.")) {
                    continue;
                }
    ...
    private static <T> Set<Class<? extends T>> scanJar(JarFile jar, Class<T> base, Class<?> annotation) throws ClassNotFoundException {
        ...
        while (entries.hasMoreElements()) {
            ...
            if (name.endsWith(".class")) {
                ...
                if (name.startsWith("namidevelopment/kiriyaga/nami/mixin/")) {
                    continue;
                }

                String className = name.replace('/', '.').replace(".class", "");

                if (!className.startsWith("namidevelopment.kiriyaga.nami.")) {
                    continue;
                }
