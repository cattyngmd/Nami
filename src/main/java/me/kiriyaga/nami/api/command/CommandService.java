package me.kiriyaga.nami.api.command;
...
public class CommandService {
    ...
    public void addCommand(me.kiriyaga.nami.impl.command.Command command) {
        storage.addCommand(command);
        suggester.updateDispatcher();
    }

    public void removeCommand(me.kiriyaga.nami.impl.command.Command command) {
