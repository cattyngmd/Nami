/*
Originally from:
https://github.com/NamiDevelopment/mint/blob/d8274468792503ccbfb1b374aaaeb74225a42056/src/main/java/net/melbourne/modules/impl/movement/StepFeature.java#L1
...
public class StepModule extends Module {
    ...
    public StepModule() {
        super("Step", "Steps up blocks (Normal mode).",
                ModuleCategory.of("Movement"), "step");
    }
