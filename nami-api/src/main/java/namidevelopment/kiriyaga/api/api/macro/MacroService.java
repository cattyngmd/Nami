package namidevelopment.kiriyaga.api.api.macro;

import namidevelopment.kiriyaga.api.api.macro.model.Macro;
...
public class MacroService {
    ...
    public boolean isKeyPressed(int keyCode) {
        return org.lwjgl.glfw.GLFW.glfwGetKey(API_MC.getWindow().handle(), keyCode) == org.lwjgl.glfw.GLFW.GLFW_PRESS;
    }
